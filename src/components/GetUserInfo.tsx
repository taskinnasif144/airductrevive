            ...
            <div className='relative p-6 rounded flex flex-col gap-6 justify-center items-center '>
                ...
                <form className=' flex flex-col justify-center items-center'>
                    <div className='flex items-center  gap-4 flex-col md:flex-row'>
                        ...
                        />
                        <select className='w-[210px] text-sm outline-none appearance-none text-center px-3 py-2'>
                            <option value="" className='focus:outline-none '>Air Duct & Ventilation Cleaning</option>
                            <option value="" className='focus:outline-none px-3 py-2'>Chimney Fireplaces Cleaning</option>
                            <option value="" className='focus:outline-none px-3 py-2'>Dryer Vent Cleaning</option>
                        </select>
                    </div>
