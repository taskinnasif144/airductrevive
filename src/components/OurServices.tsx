...
const OurServicesCard = ({ card }: OurServicesCardProps) => {
    return (
        <div className='mt-5 text-center bg-color-bg-tertiary text-white p-6 w-[250px] flex flex-col gap-5 rounded-lg h-[300px] hover:scale-105 transition-all duration-150 cursor-pointer cop'>
